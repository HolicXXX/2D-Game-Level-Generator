...
public class WebWindow : EditorWindow {
    ...
    //[MenuItem ("Level/Web Window")]
    static void Load() {
		WebWindow window = WebWindow.GetWindow<WebWindow>(true);
        //window.Show();
        window.Init();
    }
    ...
    private void InitWebView() {
        ...
        webViewType.GetMethod("InitWebView").Invoke(webView, new object[] {this, 0, 0, (int)position.width,(int)position.height,false});
